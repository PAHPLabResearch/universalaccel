...
- ActiGraph (GT3X), .gt3x raw data is passed through `?agcounts::agcalibrate()` first for autocalibration and metrics are computed.
...
- Raw device files (ActiGraph `.gt3x`, Axivity `resampled`.csv`, GENEActiv `.bin`, and generic formats)
