...
- **ROCAM** (*Rate of Change Acceleration Magnitude*): change-based activity metric derived from successive acceleration magnitude samples.
...
- `ROCAM` (*Rate of Change Acceleration Magnitude*)
- `Axis1`, `Axis2`, `Axis3` or `X`, `Y`, `Z` (*axis components; optional*)
- `Vector.Magnitude` (*optional*)
